...
SRC_URI += "git://git.codelinaro.org/clo/le/qcom-gstreamer.git;protocol=https;rev=03219e93653a22989c953c7b51fc3b3aab6a136f;branch=imsdk.lnx.2.0.0.r1-rel;subpath=gst-plugin-mlvdetection"
