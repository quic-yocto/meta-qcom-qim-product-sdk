...
SRC_URI += "git://git.codelinaro.org/clo/le/platform/vendor/qcom-opensource/gst-plugins-qti-oss.git;protocol=https;rev=517c6e0f680061674edced287e84166e3ab684b0;branch=imsdk.lnx.2.0.0.r1-rel;subpath=gst-plugin-mlqnn"
